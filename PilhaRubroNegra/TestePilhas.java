...
public class TestePilhas {
    public static void main(String[] args) {
        ...
        System.out.println("O último objeto na pilha preta é: " + pp.topPreto());
        System.out.println("O tamanho da pilha preta é: " + pp.sizePreto());
        System.out.println("O último objeto na pilha vermelha é: " + pp.topVermelho());
        System.out.println("O tamanho da pilha vermelha é: " + pp.sizeVermelho());
    }
}
